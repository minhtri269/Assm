<%-- 
    Document   : footer
    Created on : Mar 9, 2022, 5:27:48 PM
    Author     : avillX
--%>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">SpeedStyle</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">203 Lê V?n Vi?t, ph??ng T?ng Nh?n Phú A, Qu?n 9, TP.H? Chí Minh</span></li>
