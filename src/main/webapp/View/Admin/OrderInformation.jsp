                                                ...
                                                <table style="margin: 4% 24%; font-size: 20px; ">
                                                    <tr>
                                                        <td><label for="OldPass">Old Password: </label>
                                                            <input onclick="onChange1()" id="passSQL" name="passSQL" type="hidden" value="${requestScope.InforU.password}" />
                                                            <input onclick="onChange1()" type="password" size="60" value="" name="OldPass" required pattern="\S+" />
