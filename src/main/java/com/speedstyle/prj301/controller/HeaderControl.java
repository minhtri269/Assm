 ...
 * @author avillX
 */
@WebServlet(name = "HeaderControl", urlPatterns = {"/HeaderControl"})
public class HeaderControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ProductCart> listCart = cart.getProductCart();
        ...
        request.setAttribute("Cart",n);
        request.getRequestDispatcher("View/layout/header.jsp").forward(request, response);
